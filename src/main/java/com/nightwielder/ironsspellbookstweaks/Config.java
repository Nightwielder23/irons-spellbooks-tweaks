...
public class Config {
    ...
    public static final ForgeConfigSpec.DoubleValue BUFF_DURATION_MULTIPLIER;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> BUFF_DURATION_NAMESPACES;
    ...
    public static final ForgeConfigSpec.DoubleValue SUMMON_VEX_HP_MULTIPLIER;
    public static final ForgeConfigSpec.DoubleValue SUMMON_VEX_DAMAGE_MULTIPLIER;
    public static final ForgeConfigSpec.DoubleValue RAISE_DEAD_HP_MULTIPLIER;
    public static final ForgeConfigSpec.DoubleValue RAISE_DEAD_DAMAGE_MULTIPLIER;
    public static final ForgeConfigSpec.DoubleValue SUMMON_POLAR_BEAR_HP_MULTIPLIER;
    public static final ForgeConfigSpec.DoubleValue SUMMON_POLAR_BEAR_DAMAGE_MULTIPLIER;
    public static final ForgeConfigSpec.DoubleValue SUMMON_HORSE_HP_MULTIPLIER;
    public static final ForgeConfigSpec.DoubleValue SUMMON_SWORDS_DAMAGE_MULTIPLIER;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> SPELL_DAMAGE_MULTIPLIERS;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> SPELL_COOLDOWN_MULTIPLIERS;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> SPELL_MANA_COST_MULTIPLIERS;
    ...
    static {
        ...
        BUFF_DURATION_NAMESPACES = builder
                ...
                .defineList(Keys.BUFF_DURATION_NAMESPACES, List.of(IronsSpellbooksCompat.IRONS_MOD_ID, "cataclysm_spellbooks", "dacxirons", "gametechbcs_spellbooks", "gtbcs_geomancy_plus", "hazennstuff", "ias_spellbooks", "traveloptics"), entry -> entry instanceof String namespace && namespace.matches("[a-z0-9_.-]+"));
        builder.pop();
