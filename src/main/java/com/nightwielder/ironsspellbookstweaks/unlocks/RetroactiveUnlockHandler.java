...
public class RetroactiveUnlockHandler {
    ...
    public static void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
        ...
        for (UnlockDefinition unlock : UnlockManager.getAll().values()) {
            // entity_kill triggers can't be replayed retroactively because past kills are not recorded. players need to re-kill the entity, or an admin can grant it with /isstweaks grant.
