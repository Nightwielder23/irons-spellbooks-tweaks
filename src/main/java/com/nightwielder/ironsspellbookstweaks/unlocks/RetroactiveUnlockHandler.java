...
public class RetroactiveUnlockHandler {
    ...
    public static void onPlayerLoggedIn(PlayerEvent.PlayerLoggedInEvent event) {
        ...
        for (UnlockDefinition unlock : UnlockManager.getAll().values()) {
            // entity_kill triggers can't be replayed retroactively since we don't track past kills. players need to re-kill the entity, or an admin can grant it with /isstweaks grant.
